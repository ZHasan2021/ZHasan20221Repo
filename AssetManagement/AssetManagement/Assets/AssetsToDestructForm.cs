...
{
    public partial class AssetsToDestructForm : DevExpress.XtraBars.ToolbarForm.ToolbarForm
    {
        int currRow = -1;
        IQueryable<AssetTbl> assetsDS = null;
        public AssetsToDestructForm()
        {
            InitializeComponent();
        }

        public AssetsToDestructForm(IQueryable<AssetTbl> assetsPrm)
        {
            this.assetsDS = assetsPrm;
            InitializeComponent();
        }

        private void AssetsToDestructForm_Load(object sender, EventArgs e)
        {
            ...
            if (assetsDS != null)
                assetGridControl.DataSource = assetsDS;
        }
