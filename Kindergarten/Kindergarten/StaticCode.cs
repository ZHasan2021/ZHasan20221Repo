...
namespace Kindergarten
{
    public class StaticCode
    {
        ...
        public static string ApplicationTitle = "أكاديمية النشء الجديد - New generation academy";
        public static int ShiftDays = 0;
        public static int ShiftSeconds = 0;
        #endregion

        #region Db
        public static string dbPath = $"{Application.StartupPath}//Db//KindergartenDb.mdf";
        public static string db_logPath = $"{Application.StartupPath}//Db//KindergartenDb_log.ldf";
        public static string dbPath_stat = $"{Application.StartupPath}//Db//KindergartenDb2.mdf";
        public static string db_logPath_stat = $"{Application.StartupPath}//Db//KindergartenDb2_log.ldf";
        public static KindergartenDbDataContext mainDbContext = new KindergartenDbDataContext();
        ...
        public static bool BackupDb(string backupName)
        {
            try
            {
                SqlConnection dbConn = new SqlConnection(new Settings().KindergartenDbConnectionString);
                if (dbConn.State != System.Data.ConnectionState.Open)
                    dbConn.Open();
                using (SqlCommand backupDbComm = new SqlCommand($"Backup DATABASE KindergartenDb TO DISK='{backupName}'", dbConn))
                {
        ...
        public static bool RestoreDb(string backupName)
        {
            try
            {
                ...
                if (dbConn.State != System.Data.ConnectionState.Open)
                    dbConn.Open();
                using (SqlCommand backupDbComm = new SqlCommand($"RESTORE DATABASE KindergartenDb FROM DISK='{backupName}' WITH REPLACE", dbConn))
                {
                    backupDbComm.ExecuteNonQuery();
                }
                return true;
        ...
        {
            SqlConnection sqlConn = new SqlConnection(new Properties.Settings().KindergartenDbConnectionString);
        ...
        public static void ImportDataFromExcel(string excelFilePath)
        {
            ...
            string ssqlconnectionstring = new Properties.Settings().KindergartenDbConnectionString;
            ...
            List<string> tblsToImport = new List<string>() { "StudentTbl", "StudentFeeTbl" };
            List<string> keyFields = new List<string>() { "ID", "ID" };
